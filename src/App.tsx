        ...
        <div className="div">
            ...
            <div className="title-area-conteiner">
              <div className="title-area-content">
                <div className="frame">
                  ...
                  <p className="p">
                    This is a company that develops apps, websites, and software. We provide features and services for
                    its users.
                  </p>
                </div>
              ...
              <div className="features-conteiner">
                <div className="feature-card">
                  ...
                  <p className="text-wrapper-7">
                    This is a description of the first feature of our site. We are going to briefly outline what this
                    feature does.
                  </p>
                ...
                <div className="feature-card">
                  ...
                  <p className="text-wrapper-7">
                    This is a description of the second feature of our site. We are going to briefly outline what this
                    feature does.
                  </p>
                  <button className="button-text-wrapper">
                    <button className="button-text-2">Learn more</button>
                ...
                <div className="feature-card">
                  ...
                  <p className="text-wrapper-7">
                    This is a description of the third feature of our site. We are going to briefly outline what this
                    feature does.
                  </p>
                  <button className="button-text-wrapper">
                    <button className="button-text-2">Learn more</button>
                ...
                <div className="feature-card">
                  ...
                  <p className="text-wrapper-7">
                    This is a description of the fourth feature of our site. We are going to briefly outline what this
                    feature does.
                  </p>
                  <button className="button-text-wrapper">
                    <button className="button-text-2">Learn more</button>
          ...
          <div className="price">
            <div className="title-area-conteiner-2">
              ...
              <img className="rectangle" src="img/rectangle-1.png" />
            </div>
          </div>
          <div className="technologies">
            <div className="frame-7">
              <div className="element-wrapper">
                <img className="element" src="img/5673721-1.png" />
              </div>
            ...
            <div className="feature-card-2">
              ...
              <div className="frame-13">
                <div className="frame-14">
                  <div className="text-wrapper-12">Data Gathering</div>
                </div>
                <div className="we-need-a-thorough-wrapper">
                  <p className="we-need-a-thorough">
                    We need a thorough<br />understanding of your business goals and needs.
                  </p>
                </div>
              </div>
